...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <div class="navbar">
          <form class="form-inline" action="<?php echo constant('URL');?>Correspondencia/buscarUsuarioGenerado" method="POST">
            <div class="input-group mb-3">
                <input type="text" class="form-control" name="usuario" placeholder="Nombre del Usuario" aria-label="Nombre del Destinatario" aria-describedby="button-addon2">
