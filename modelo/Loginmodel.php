            ...
            try{
                ...
                if(empty($resultado)){
                    ...
                    if($this->password == $resultado['password']){
                        ...
                        $query2 = 'SELECT idUsuario, username, password,rut, nombre_usuario, apellido_p, apellido_m, email, unidad_trabajo, tipo_usuario_idtipo_usuario FROM usuario  WHERE rut=?';
